...
def human(x, y, dx, scrn):
    ...
    # torso and limbs
    color = (145, 124, 111)
    ellipse(scrn, color, (x + round(0.16 * dx), y + round(0.25 * dy), round(0.68 * dx), round(1.12 * dy)))
    rect(scrn, (255, 255, 255), (x + round(0.16 * dx), y + round(0.81 * dy), round(0.68 * dx), round(0.57 * dy)))
    ellipse(scrn, color, (x, y + round(0.4 * dy), round(0.4 * dx), round(0.1 * dy)))
    scrn.blit(ellipse_rotation(round(0.4 * dx), round(0.15 * dy), round(0.1 * dy), -1, color),
              (x + round(0.55 * dx), y + round(0.37 * dy)))
    ellipse(scrn, color, (x + round(0.3 * dx), y + round(0.7 * dy), round(0.19 * dx), round(0.28 * dy)))
    ellipse(scrn, color, (x + round(0.51 * dx), y + round(0.7 * dy), round(0.19 * dx), round(0.28 * dy)))
    ellipse(scrn, color, (x + round(0.22 * dx), y + round(0.9 * dy), round(0.2 * dx), round(0.1 * dy)))
    ellipse(scrn, color, (x + round(0.58 * dx), y + round(0.9 * dy), round(0.2 * dx), round(0.1 * dy)))
...
def cat(x, y, dx, scrn):
    ...
    ellipse(scrn, color_1, (x + round(0.152 * dx), y + round(0.318 * dy), round(0.508 * dx), round(0.327 * dy)))
    scrn.blit(ellipse_rotation(round(0.372 * 0.9 * dx), round(0.473 * 0.9 * dy), round(0.2 * dy), 1, color_1),
              (x + round(0.6 * dx), y))
    scrn.blit(ellipse_rotation(round(0.254 * dx), round(0.364 * dy), round(0.14 * dy), -1, color_1),
              (x + round(0.58 * dx), y + round(0.455 * dy)))
    scrn.blit(ellipse_rotation(round(0.254 * dx), round(0.455 * dy), round(0.14 * dy), -1, color_1),
              (x + round(0.508 * dx), y + round(0.5 * dy)))
    scrn.blit(ellipse_rotation(round(0.338 * dx), round(0.273 * dy), round(0.14 * dy), 1, color_1),
              (x + round(0.054 * dx), y + round(0.518 * dy)))
    scrn.blit(ellipse_rotation(round(0.302 * dx), round(0.182 * dy), round(0.14 * dy), 1, color_1),
              (x, y + round(0.436 * dy)))

    # the fish:
    f1x, f1y = x + round(0.12203 * dx), y + round(0.2818 * dy)
    polygon(scrn, color_5, [(f1x, f1y), (f1x - round(0.0136 * dx), f1y + round(0.0545 * dy)),
                            (f1x + round(0.061 * dx), f1y + round(0.191 * dy)),
                            (f1x + round(0.0406 * dx), f1y + round(0 * dy))])
    f2x, f2y = x + round(0.1355 * dx), y + round(0.15 * dy)
    polygon(scrn, color_5, [(f2x, f2y), (f2x + round(0.0237 * dx), f2y + round(0.0909 * dy)),
                            (f2x + round(0.0542 * dx), f2y + round(0.109 * dy)),
                            (f2x + round(0.0677 * dx), f2y + round(0.036 * dy))])
    scrn.blit(ellipse_rotation(round(0.17 * dx), round(0.275 * dy), round(0.14 * dy), -1, color_2),
              (x + round(0.0916 * dx), y + round(0.164 * dy)))
    tx, ty = x + round(0.249 * dx), y + round(0.4181 * dy)
    polygon(scrn, color_2, [(tx, ty), (tx + round(0.0779 * dx), ty + round(0 * dy)),
                            (tx + round(0.0508 * dx), ty + round(0.118 * dy))])
    circle(scrn, (0, 1, 253), (x + round(0.1254 * dx), y + round(0.256 * dy)), round(0.01356 * dy))
    circle(scrn, color_4, (x + round(0.1254 * dx), y + round(0.256 * dy)), round(0.00678 * dy))

    # the face:
    line(scrn, color_3, (x + round(0.176 * dx), y + round(0.272 * dy)),
         (x + round(0.176 * dx), y + round(0.37 * dy)), 2)
    line(scrn, color_3, (x + round(0.21 * dx), y + round(0.318 * dy)),
         (x + round(0.21 * dx), y + round(0.42 * dy)), 2)
    ellipse(scrn, color_1, (x + round(0.16 * dx), y + round(0.1 * dy), round(0.16 * dx), round(0.3 * dy)))
    circle(scrn, color_4, (x + round(0.2 * dx), y + round(0.269 * dy)), round(0.01017 * dy))
    ellipse(scrn, color_3, (x + round(0.195 * dx), y + round(0.12 * dy), round(0.03 * dx), round(0.08 * dy)))
    ellipse(scrn, color_3, (x + round((0.25 - 0.009) * dx), y + round((0.156 + 0.03) * dy),
                            round(0.03 * dx), round(0.08 * dy)))
    circle(scrn, color_4, (x + round(0.215 * dx), y + round(0.156 * dy)), round(0.01017 * dy))
    circle(scrn, color_4, (x + round((0.275 - 0.009) * dx), y + round((0.192 + 0.03) * dy)), round(0.01017 * dy))

    # ears:
    x_1, y_1 = x + round(0.21 * dx), y + round(0.0909 * dy)
    x_2, y_2 = x + round(0.278 * dx), y + round(0.1 * dy)
    polygon(scrn, color_1, [(x_1, y_1 + round(0.018 * dy)), (x_1 + round(0.0338 * dx), y_1 + round(0 * dy)),
                            (x_1 + round(0.013 * dx), y_1 - round(0.0636 * dy))])
    polygon(scrn, color_1, [(x_2, y_2 + round(0.018 * dy)), (x_2 + round(0.0339 * dx), y_2 + round(0.0909 * dy)),
